...
public class Fornecedores extends JDialog {
		...
		if (txtRazaoSocial.getText().isEmpty()) {
			...
			try {
				...
				if (confirma == 1) {
					...
					// System.out.println(e1);
					JOptionPane.showMessageDialog(null, "Funcionario N�o Adicionado");
					limpar();
				}
				...
				JOptionPane.showConfirmDialog(null, "Fornecedor n�o adicionado - CNPJ Duplicado");
				txtCnpj.setText(null);
				txtCnpj.requestFocus();
			}
	...
	public void deleteByidFor() {
		...
		// Valida��o
		int confirma = JOptionPane.showConfirmDialog(null, "Confirma a Exclus�o deste Fornecedor?", "Aten��o",
